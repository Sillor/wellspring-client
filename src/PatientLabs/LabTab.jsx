...
export default function LabTab(props) {
  ...
  return (
    <>
      <table
        className="table-fixed justify-between w-full border-separate"
        id="table"
      >
        <tbody>
          <tr className="table-row w-full h-10 border-spacing-y-3">
            <td htmlFor="generalInfo" className="table-cell w-1/2 font-bold">
              Procedure Name:
            </td>
            <td htmlFor="generalInfo" className="table-cell w-1/3 font-bold">
              Ordered By:
            </td>
            <td htmlFor="generalInfo" className="table-cell w-1/3 font-bold">
              Date:
          ...
          <tr className="table-row h-4">
            <td htmlFor="generalInfo" className="table-cell w-auto">
              {props.lab.Lab}
            </td>
              ...
              <td colSpan={2}>
                <div className="flex flex-col w-1/2">
                  <Button
                    ...
                    className="visible"
                    id={"editBtn" + " " + props.index}
                  >
                    Edit {props.lab.Lab} Results
                  </Button>
                  <Button
                    onClick={saveEdit}
                    id={"saveBtn" + " " + props.index}
                    className="invisible"
                  >
                    Save Results
                  </Button>
